...
> **Secure your Linux infrastructure with this security information by [Chris Binnie](https://chrisbinnie.github.io/about.html)** Learn essential hardening techniques from my working notes including intrusion detection and defense strategies for: Ubuntu, CentOS, RHEL and Debian servers. This guide covers many facets from basic setup to advanced threat protection.
...
If you are new to Linux, I would recommend practising in a virtual machine, where you are free to break things without causing headaches. Watch out for opening the virtual machine up to the internet accidentally though.
...
In case you missed it, my complete guide on [how to achieve Grade A+ SEO, security and performance on your website](https://chrisbinnie.github.io/100-per-cent-website-seo-security-performance-scores).
